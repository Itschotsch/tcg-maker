...
class TCGMakerHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        settings = {
            ...
            "release_label_display": form["release_label_display"].value if "release_label_display" in form else None,
            "release_label_filename": form["release_label_filename"].value if "release_label_filename" in form else None,
            "backside_filename": form["backside_filename"].value if "backside_filename" in form else "cardback.png",
            "card_width_mm": int(form["card_width_mm"].value) if "card_width_mm" in form else None,
            "card_height_mm": int(form["card_height_mm"].value) if "card_height_mm" in form else None,
            "bleed_mm": int(form["bleed_mm"].value) if "bleed_mm" in form else None,
            "border_radius_mm": int(form["border_radius_mm"].value) if "border_radius_mm" in form else None,
            "dpi": int(form["dpi"].value) if "dpi" in form else None,
